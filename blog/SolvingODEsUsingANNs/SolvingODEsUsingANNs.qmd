...
The impressive capabilities of neural networks in typical regression and classification tasks are widely known. Recently, I read of a lesser known but mathematically very interesting application of neural networks. In fact, neural networks, more specifically multilayer perceptrons, can be used to numerically approximate the solutions of differential equations. What makes them suitable for this task is not only that they are highly flexible in approximating arbitrary functions but that they are differentiable. 
