...
This can be achieved by minimizing a special loss function $L_{total}$ over a set of $n \in \mathbb{N}$ sample points from $I$, $x_i \in I, i=1,\dots, n$. The special loss function $L_{total}$ depending on $\theta$ consists of two parts:
...
$L_{ODE}$ measure using mean square deviation from ODE
