...
Next, I instantiate the neural network, the loss function to be minimized and the optimizer (here, I use Adam).
...
### Visualize the Approximate and the Analytical Solution
...
$$ e^{-0.5x} \times \left[ 0.5 \times \cos\left(\frac{\sqrt{15}}{2} x \right) + \frac{3 \sqrt{15}}{10} \times \sin \left( \frac{\sqrt{15}}{2} x \right) \right] $$
