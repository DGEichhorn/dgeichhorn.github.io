...
This can be achieved by minimizing a special loss function $L_{total}$ over a set of $n \in \mathbb{N}$ sample points, $x_i \in I, i=1,\dots, n$. The special loss function $L_{total}$ depending on $\theta$ consists of two parts:
...
wie kriegt man das, mittels standard optimizer wie z.B. Adam

somit ist die numerical approximation der lösung des ivp, i.e. der unknown function u gegeben durch
N theta star
