...
The approach by @magdon1998neural relies on the following two useful properties of the **CDF**:
...
@magdon1998neural proposed to use a neural network, that is differentiable, to approximate the **CDF** and take afterwards the first derivative w.r.t. $x$ to obtain an estimate of the **PDF**. 
