...
get NHL data from <https://www.pro-football-reference.com/years/2024/games.htm>; OLD NHL: <https://www.hockey-reference.com/leagues/NHL_2025_games.html#games>
...
#   dann v,h += 1
# for (g in 1:dim(games)[1]) {
#   if (games[g, "Goals.V"] > games[g, "Goals.H"]) {
#     W[games[g, "Visitor"], games[g, "Home"]] <- 
#       W[games[g, "Visitor"], games[g, "Home"]] + 1
#   }else{
#     W[games[g, "Home"], games[g, "Visitor"]] <- 
#       W[games[g, "Home"], games[g, "Visitor"]] + 1
#   }
# }
```
