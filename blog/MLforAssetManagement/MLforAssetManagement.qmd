...
description: "As part of my master's thesis I implemented a machine learning based approach for managing stock portfolios. I describe how this approach works and assess the performance of these portfolios."
...
Those interested in the technical details may scroll down to the bottom (section Appendix), where the pdf-file of my master's thesis is displayed. Unlike most of the other posts, in the remainder of this post, I will not go into the technical details or show any code. I will rather give an high-level overview of what I did as part of my master's thesis.
